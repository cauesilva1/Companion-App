-- Morning no 1º foreground do dia (sem depender de sleep→wake) + não injeta música no feed.
...
BEGIN
  ...
  -- 1º foreground do dia (acordado) seeda morning mesmo sem sleep overnight.
  ...
  -- Música: só mediaHint no companion (banner iOS). Sem bolha "Som na sala" no feed.
